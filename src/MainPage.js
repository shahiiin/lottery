  ...
  render () {
    return (
      <div className="cash-main-page">
        {this.state.users.map (item => <Menu id={item.id} />)}

        <Card className="main-page-wallpaper" style={{width: 300}}>
          <div>
            <div style={{textAlign: 'right'}}>
              <Row type="flex" justify="end">
                ...
                <Col span={4} />
                <Col span={4}>
                  {' '}  <h5 className="content1-mainpage">محمد جواد</h5>
                  <h5 className="content2-mainpage">موجودی کارت:3</h5>
                </Col>
                <Col span={4}>
                  <img
      ...
      "
              ...
              {this.state.users.map (item => (
                ...
                >
                  <div style={{width: 170}}>
                    <div>
                      <h4 className="kash-month">{item.name}</h4>
                      <p className="kash-month-param text-left">مشاهده</p>
                      ...
                      >
                        ...
                        <Moment fromNow ago date={item.created_at} />
              ...
              >
                <div style={{width: 170}}>
                  ...
                  <div>
                    <h4 className="kash-month">نام صندوق</h4>
                    <p className="kash-month-param text-left">مشاهده</p>
                    <Progress percent={this.state.percent} />
                    <p
                      className="kash-month-param-2 text-right"
                    ...
                    <p
                      className="kash-month-param-4 text-left"
                      style={{direction: 'rtl'}}
                    >
                      تومان 
                    </p>
                    <button className="add-user-2">
                      اشتراک گذاری صندوق
                      <FaUserPlus style={{marginTop: 2, marginLeft: 4}} />
                    </button>
                  </div>
                </div>
              </Card>
